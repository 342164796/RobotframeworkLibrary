...
综艺详情页
    ...
    load    ${VOD_DIR}/tecent/
    req    MediasApiMedia11011943131_1
    Path    MediasApiMedia11011943131_1    4=11011968755_0_1
    Json Struct Compare    MediasApiMedia11011943131_1
    expect    /category    reg_match    综艺    MediasApiMedia11011943131_1
    expect    /id    =    11011968755    MediasApiMedia11011943131_1
    expect    /title    reg_match    你正常吗 第3季    MediasApiMedia11011943131_1
